// Thai wordlist for the offline spell checker (~61,000 words).
// Source: PyThaiNLP (https://github.com/PyThaiNLP/pythainlp), corpus/words_th.txt — Apache License 2.0.
// This is a general-purpose Thai wordlist, NOT an official ราชบัณฑิตยสภา dataset (no such open dataset is publicly available).
// It is used here only to flag words that don't match a known dictionary entry — it cannot detect meaning or grammar errors.
const THAI_WORDS_RAW = `ก.
ก.ค.
ก.ต.
ก.ป.ส.
ก.พ.
...
สัตวา
สัตวาร
สัตวแพทยศาสตรดุษฎีบัณฑิต
สัตวแพทยศาสตรบัณฑิต
สัตวแพทยศาสตรมหาบัณฑิต
สัตวแพทยศาสตร์
สัตวแพทย์
สัตวโลก
สัตว์
